...
% % ==============
\section{Sensorinstallation für Heimautomatisierungssysteme}
...
Die \emph{Platzierung} beeinflusst die Datenqualität bei der Auslesung einer
physikalischen Größe von einem Sensorknoten. Die Positionierung wird weiterhin
in zwei Unterfaktoren aufgeteilt: \emph{Proximität} und \emph{Direktionalität}.
Der \emph{Proximitätsfaktor} gibt an wie nahe der Sensor an sein Messziel
...
Die \emph{Präzision} einer \emph{Assoziation} wird als Funktion der
...
Die Teilnehmer der Studie erhlaten vor Beginn des Experiments eine Übersicht des
Konzeptes, dass hinter dem Heimautomatisiezungssytem steht und nur die
Platzierung, Ausrichtung und Assoziation zwischen den Sensoren und ihren
beobachteten Gegenständen wird bewertet. In der Studie werden keine Aktuatoren
oder Interaktionen zwischen den Sensoren betrachtet.

% Kurz sagen wie die mitgelieferte Doku war trebe scurtat ce ii jos
Die Studie ist auf den Umgang der Anwender auf die Sensorinstallation
...
Verhalten und Zwech der anzubringenden Sensoren.
...
\begin{figure}[htb]
  ...
  \caption{Ausschnitte aus der Dokumentation C, die auf dem PDA angezeigt werden
  \cite{Beckmann2004}}
...
Die Resultate der Evaluierung werden im Folgenden zusammengefasst.
...
% 8 von den 15 Teilnehmern (53\%) haben wenigstens einen, aber
...
\begin{enumerate}
  \item \textbf{Das konzeptuelle Modell der Benutzer bei bekannten
  Technologien angemessen nutzen}\\ Bekannte Technologie, die wie
  gewohnt bentuzt wird unterstützt das Verständniss, da die schon
  bestehenden konzeptuellen Modelle der Nutzer wiederverwendet werden. Der
  umgekehrte Effekt ensteht jedoch, wenn vertraute Technologien anders als im
  ...
  \item \textbf{Inkorrekte Installationen sollten erkannt werden
   ...
   aufnehemen, nicht installieren, obwohl sie einen Mehrwert in der
...
Fehlinstallationen, durch die Analyse und den Vergleich von Sensor Daten mit
Richtwerten, können dem Anwender gemeldet werden.
Dieses Real-Time-Feedback während der Installation kann das konzeputelle Modell

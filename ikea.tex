...
nicht zu über- oder unterfordern. Die von den Autoren definierten
...
ermöglicht Zustände des Systems ohne die Befolgung einer bestimmten Rheinefolge
...
Diese widerrum ermöglichen, unter der Verwendung eines Hidden Markov Model, die
Identifikation von vollständig durchgeführten Schritten (Schraube ist in
Gewinde).
% ============================================= %
\cite{Antifakos2002} weisen darauf hin, dass der so identifizierte Fortschritt
der Installation, dem Anwender durch ein geignetes Medium präsentiert werden

...
\begin{figure}[htb]
  ...
  \caption{Das Kit für die Installation mit Sensoren,
  Klebematerial, einem PDA und Gegenstandskatalog und der
  Dokumentation}
...
Dokumentationen, gab. Von den 5 Nutzern mit Dokumentation C haben sich
3 solche Informationen aber gewünscht. Abbildung
\ref{fig:assembly-doku_c} zeigt einen Ausschnitt aus Dokumentation C.
Man bemerkt, dass die Dokumentation sehr wenig Informationen enthält
und auch die Sensoren werden nach ihren Farben benannt.

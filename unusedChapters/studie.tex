...
Die Erkundungsphase, in der ein Überblick über das System und dessen
Komponenten gegeben wird, kann mit Hilfe eine Online-Konfigurators
ersetzt werden. Dem Benutzer wird das System im ganzen Präsentiert und
er hat die Möglichkeit die Komponenten auszuwählen die ihn
interessieren. Wird der Konfigurator benutzt kann automatisch für
...
Szenario
Konfigurationsportal zum Auswählen der gewünschten Komponenten
Nach der Auswahl werden individuelle Handbücher erstellt
...
An einem Ort, wie z.B. Living Labs oder bei dem Nutzer zu Hause wird die Installation durchgeführt

Gruppen festlegen
2 Gruppen mit der selben Aufgabe aber verschiedene Handbücher
Selektion der Teilnehmer
Ist Alter ein wichtiger Faktor
Technologie sollte möglichst allen Gruppen einen Nutzen bringen
...
Referenzimplementierung der Handbücher muss gemacht werden.
Ein Handbuch, das mit einem solchen System kommt erhalten und bei einer Gruppe einsetzen

Ziel
Erfahren ob Nutzer ein Custom Handbook interessieren würde
Personenbefragungen 
Das Einsatzszenario einer Intelligente Heimautomatisierung erklären mit einer Individuell zugeschneiderten Bedienungsanleitung
Die emotionale Reaktion könnte signifikant sein
...
%============Wizard of Oz
Um eine Wizard of Oz Studie durchzuführen wird 
...
Es kann passieren, dass Nutzer wichtige Anweisungen übersehen oder
nicht befolgen, daher wäre es nützlich diese hervorzuheben.

Metamodell sollte Assoziation und direktionalität in betracht nehmen
um erstens detailiertere Angaben über die Insallation zu geben wenn
ein Sensor kompliziert zu installieren ist oder viele Faktoren dort
einfliessen. Aber auch um die nötigen Infomrationen zu enthalten um
die Fehlerfindung und bewertung der Insallation durchführen zu können.
Mass für komplexität:
direktionalität.


%============Durchzuführende Aufgaben
 Die Aufgaben die bei der Installation durchzuführen sind:
...
\begin{table}
  ...
  \begin{tabular}{l c c c c c}
    ...
    Objekte & Aktuatoren & Sensoren  & Direktional & Proximität  \\   
    [1ex]
...
Um die Installation bewerten zu können muss eine korrekte Definition
der Installation gegeben werden. Um die Bewertung durchzuführen werden
die Assozierung, Positionierung, Konfigurierung und weiter Aspekte in
betracht gezogen.
Folgende Tabelle zeigt es ausführlich 
